...
//            let contentController = _contentController
...
//      }
    ...
    func commitCalendarViewUpdate() {
      ...
      // Added by me
      func commitCalendarViewResize() {
            contentController.resizeFrames( bounds )
      }
      
      func heightLightCurrentDay() {
            contentController.heightLiehtTheCurerntDay()
      }
